...
#define MSG_BAN_PLAYER (char) 10 // 服务器广播玩家被BAN卡封禁, content 为被封禁玩家的序号(len:1)
...
#define MSG_PLUS4 (char) 13 // 服务器广播 PLUS4 牌被打出, content 为被加四张牌的玩家序号(len:1), 被加上的牌的牌号(len4*3) 非该玩家的客户端应忽略牌号
...
#define MSG_GAME_START (char) 23 // 服务器广播游戏开始
#define MSG_GAME_OVER_WITH_EXCEPTION (char) 24 // 服务器广播游戏异常结束
/**
 * 读取消息类型
 * */
